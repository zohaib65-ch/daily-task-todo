  ...
  return (
    <Card>
      ...
      <CardContent className="grid gap-4">
        <div className="flex items-center space-x-4 rounded-md border p-4">
          <div className="flex-1 space-y-1">
            <p className="text-xs text-muted-foreground">{notification3.time}</p>
            <p className="text-sm font-medium leading-none">{notification3.title}</p>
            <p className="text-sm text-muted-foreground">{notification3.description}</p>
          </div>
        </div>
      </CardContent>
    </Card>
