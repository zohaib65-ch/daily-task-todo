...
export function EmailVerificationForm() {
  ...
  const handleResendEmail = async () => {
    ...
    try {
      ...
      alert(
        "This feature is not yet implemented. A verification email would be sent to " +
          user.email
      );
    } catch (error) {
          ...
          <div className="flex justify-center mt-6">
            <Link to="/dashboard">
              <CustomButton
                ...
                className="minest-gradient text-white shadow-md shadow-primary/20 hover:opacity-90 transition-opacity"
              />
            </Link>
          </div>
        </CustomCard>
